...
@interface FQShareView ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@property(nonatomic, weak)UICollectionView *shareCollectionView;//分享列界面

@property(nonatomic, weak)UICollectionView *functionCollectionView;//功能列界面
...
- (void)showInView:(UIView *)view{
    ...
    [shareCollectionView registerClass:[FQShareItemCell class] forCellWithReuseIdentifier:kCellIdentifier_IFMShareItemCell];
    ...
    if (self.functionItems) {
        ...
        [functionCollectionView registerClass:[FQShareItemCell class] forCellWithReuseIdentifier:kCellIdentifier_IFMShareItemCell];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FQShareItemCell *shareItemCell = [collectionView dequeueReusableCellWithReuseIdentifier:kCellIdentifier_IFMShareItemCell forIndexPath:indexPath];
    ...
    if (collectionView == self.shareCollectionView) {
        if ([self.shareItems[indexPath.row] isKindOfClass:[NSString class]]) {
            shareItemCell.shareItem = [[FQShareItem alloc] initWithPlatformName:self.shareItems[indexPath.row]];
        }else{
        ...
        if ([self.functionItems[indexPath.row] isKindOfClass:[NSString class]]) {
            shareItemCell.shareItem = [[FQShareItem alloc] initWithPlatformName:self.functionItems[indexPath.row]];
        }else{
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    FQShareItemCell *cell = (FQShareItemCell *)[collectionView cellForItemAtIndexPath:indexPath];
